...
urlpatterns = [
    ...
    path('api/', include('invoices.urls')),  # Assuming 'invoices.urls' contains your API paths
    path('api-auth/', include('rest_framework.urls')),  # Django Rest Framework authentication URLs
